...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$data['text_select_shipping'] = $this->language->get('text_select_shipping');
			...
			$data['button_select_shipping'] = $this->language->get('button_select_shipping');
			...
			foreach ($products as $product) {
				...
				$data['total_itens'] =  $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0);
			...
			$data['hasShippingMethod'] = isset($this->session->data['shipping_method']);
	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['total_itens'] =  $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0);
			} else {
